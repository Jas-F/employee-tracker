...
INSERT INTO role (title, salary, department_id) values ('CPA, 75,000, Accounting');
...
INSERT INTO employee (First_name, Last_name, role_id, manager_id) values ('Mark, Cuban, CPA, 15');
